...
namespace MetricsAgent.Controllers
{
    ...
    public class CpuMetricsController : ControllerBase
    {
        ...
        public IActionResult GetAll()
        {
            ...
            if (_logger != null)
                _logger.LogDebug("Успешно выведена информация о всех метриках cpu");
            return Ok(response);
        }
            ...
            [FromRoute] TimeSpan fromTime, [FromRoute] TimeSpan toTime)
        {
            ...
            if (_logger != null)
                _logger.LogDebug("Успешно выведена информация о метриках cpu период с {0} по {1}", fromTime, toTime);
            return Ok(response);
        }
